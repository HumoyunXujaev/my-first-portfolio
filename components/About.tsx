  ...
  return (
    <section className="flex flex-col mb-12">
      ...
      <Text style={{ marginBottom: `${TEXT_MARGIN_BOTTOM}rem` }}>
        I&apos;m a {new Date().getFullYear() - 2008} years old software engineer
        from Uzbekistan, I specialize in web development.
      </Text>
      <Text style={{ marginBottom: `${TEXT_MARGIN_BOTTOM}rem` }}>
      ...
      <Text style={{ marginBottom: `${TEXT_MARGIN_BOTTOM}rem` }}>
        Besides programming, I like to play basketball, travel in my
        spare time and go out with my friends.
      </Text>
    </section>
  );
};
